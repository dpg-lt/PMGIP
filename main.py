...
from model import MultiInferRNNModel
import utils
...
def train(args):
    ...
    instances_test = load_data_instances(test_sentence_packs, word2index, args)
    ...
    for i in range(args.epochs):
        ...
        joint_precision, joint_recall, joint_f1 = eval(model, testset, args)
...
if __name__=='__main__':
    ...
    # for multi-head
    parser.add_argument('--hidden_size', type=int, default=256, help='batt hidden size')
    parser.add_argument('--num_attention_heads', type=int, default=4, help='batt head num')
